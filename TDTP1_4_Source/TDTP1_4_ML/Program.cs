...
class Program
{
    static void Main(string[] args)
    {
        ...
        var predictionEngine = mlContext.Model.CreatePredictionEngine<CarData, CarPrediction>(model);

        // Exemple de véhicule fictif
        var sample = new CarData
        {
            Puissance = 96f,
            PoidsAVide = 1519f,
            ConsoMixte = 6.6f,
        ...
        Console.WriteLine($"Prédiction CO2 : {prediction.CO2} g/km");
